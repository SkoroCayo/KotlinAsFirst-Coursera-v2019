 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (48 * sagenes + 16 * arshins + vershoks) * 4.445 / 100
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * (1.0 + percent / 100.0).toDouble().pow(3.0)
 ...
 */
fun numberRevert(number: Int): Int = Integer.parseInt(StringBuffer(number.toString()).reverse().toString())
